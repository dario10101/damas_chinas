        ...
        for i in range(len(self.model)):
            ...
            for j in range(len(row)):
                ...
                if(val == 1):
                    ...
                    self.canvas.create_rectangle(x,y,x+self.cellwidth,y+self.cellheight, fill="white")
    ...
    def __onClick(self, event):
        if self.varClick == 1:
            ...
            if(self.ComprobarLibre(movimiento) == True):
                ...
                if(nodoAComer[0] != -1):
                    self.model[varI][varJ] = self.player
        ...
        if(abs(diferenciaI) == 2 and abs(diferenciaJ) == 2):   
            if(self.pos[0] > movimiento[0]):
                ...
                if(diferenciaJ < 0):
                    ...
                    posicionJNodoAComer = self.pos[1] + 1
                if(self.model[posicionINodoAComer][posicionJNodoAComer] == 1):
